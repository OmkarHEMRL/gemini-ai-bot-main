  ...
  const acceptresponse = async (data: SearchInputType) => {
    ...
    const chat = model.startChat({
      ...
      history: [
        {
          role: "user",
          parts: [{ text: "Omkar Sarshetti is the author" }],
        },
        {
          role: "model",
          parts: [
            {
              text: ".Hello, I am Omkar Sarshetti, This model is created by Google AI. I am here to help you with your queries. Please ask me anything.",
            },
          ],
        },
      ],
